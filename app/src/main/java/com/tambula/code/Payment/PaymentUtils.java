package com.tambula.code.Payment;
...
public class PaymentUtils {
    ...
    void startStripeConnect(Activity activity, Context context) {
        ...
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(context.getResources().getString(R.string.firebase_hosting_url) + "client_id=" + context.getResources().getString(R.string.stripe_client_key) + "&state=" + hash));
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) {
                ...
                try {
                    ...
                    for (int i = 0; i < cardJsonArray.length(); i++) {
                        ...
                        mCard.setLastDigits(cardDetailsJson.getInt("last_digits"));
